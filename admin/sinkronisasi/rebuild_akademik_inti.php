...
$page_title = "Rebuild Akademik Inti";
$page_subtitle = "Membangun ulang struktur kurikulum, kelas kuliah, dosen pengajar, dan peserta kelas";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        $hasil = rebuild_akademik_inti($conn);
    } catch (Throwable $e) {
        $error = $e->getMessage();
    }
}
    ...
    <div class="container-fluid p-0">
        ...
        <?php if ($hasil): ?>
            <div class="alert alert-success">
                Struktur akademik inti berhasil dibangun ulang.
            </div>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Bangun Relasi Akademik Inti</h5>
            </div>
            <div class="card-body">
                <p class="text-muted">
                    Proses ini menyusun ulang <code>matkul_kurikulum</code>, <code>kelas_kuliah</code>,
                    <code>dosen_pengajar_kelas</code>, dan <code>peserta_kelas_kuliah</code> dari data
                    kurikulum, mata kuliah, jadwal kuliah, dosen, KRS, dan mahasiswa yang sudah ada.
                </p>
                <form method="post">
