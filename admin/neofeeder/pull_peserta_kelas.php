...
$total_krs = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) total FROM krs"))['total'] ?? 0;
$total_detail = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) total FROM krs_detail"))['total'] ?? 0;
