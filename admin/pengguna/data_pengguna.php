...
$total_pengguna = pengguna_count($conn, "SELECT COUNT(*) AS total FROM users");
$total_aktif = pengguna_count($conn, "SELECT COUNT(*) AS total FROM users WHERE status='aktif'");
$total_nonaktif = pengguna_count($conn, "SELECT COUNT(*) AS total FROM users WHERE status='nonaktif'");
...
$total_data_filter = pengguna_count($conn, "
...
$data_pengguna = pengguna_all($conn, "
